        ...
        >
          ...
          >
            ...
            >
              ...
              <b-form-invalid-feedback>
                {{ getEmailErrorMessage(validationContext.errors[0]) }}
              </b-form-invalid-feedback>
            </b-form-group>
          </validation-provider>
          ...
          >
            ...
            >
              ...
              <b-form-invalid-feedback>
                {{ getPasswordErrorMessage(validationContext.errors[0]) }}
              </b-form-invalid-feedback>
            </b-form-group>
          </validation-provider>
          ...
          >
            ...
            >
              ...
              <b-form-invalid-feedback>
                {{ getPhoneNumberErrorMessage(validationContext.errors[0]) }}
              </b-form-invalid-feedback>
            </b-form-group>
          </validation-provider>
...
export default {
  ...
  computed: {
    ...
    title() {
      return this.isEditing ? 'Modifier un admin' : 'Ajouter un nouvel admin'
    },
    passwordToggleIcon() {
  ...
  setup(props, { emit }) {
    ...
    const onSubmit = () => {
      ...
      if (props.value) action = store.dispatch('user-module/editAdmin', adminData.value)
      else action = store.dispatch('user-module/addAdmin', adminData.value)
      ...
      action.then(() => {
        toast({
          ...
          props: {
            // TODO: change to isEditing
            title: `L'administrateur a été ${props.value ? 'modifié' : 'ajouté'} avec succès!`,
