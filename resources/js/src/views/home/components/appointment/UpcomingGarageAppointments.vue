			...
			<table>
				...
				<tbody>
					...
					<tr v-else v-for="upcomingAppointment in paginatedAppointments" :key="upcomingAppointment.id">
						<td>{{ upcomingAppointment.client.first_name }} {{ upcomingAppointment.client.last_name }}</td>
						<td>
						...
						<td v-else>-</td>
						<td>
							<span  v-if="upcomingAppointment.status == 'pending' || upcomingAppointment.status == 'confirmed'">
